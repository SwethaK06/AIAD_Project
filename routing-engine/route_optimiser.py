...
def optimize_route(req: RouteRequest):
    ...
    #  Query OSRM for spatial route alternatives
    osrm_url = (
    ...
    for candidate in candidate_routes:
        ml_payload = {
            ...
            "traffic_conditions": candidate["traffic_level"], 
            "distance_km": candidate["distance_km"],
            "package_weight_kg": req.cargo_weight_kg
        }
    ...
    # Format response for Frontend UI interation
    formatted_options = []
